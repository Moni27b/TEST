  ...
  <!-- Formulaire type modal (Bootsrap) pour entree les champs de la table CB ( carte bancaire) -->
              ...
              <div class="modal-body">
                <form>
                  ...
                  <div class="form-group">
                    ...
                    <input min='1000000000000000' max='9999999999999999' type="number" class="form-control" id="Numero_CB" placeholder="ex: 2312 2233 5675 4432" name="Numero_CB" required >
                  </div>
                  <div class="form-group">
